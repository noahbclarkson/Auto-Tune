  ...
  return (
    <div className={`max-w-xs rounded-xl border ${c.border} bg-gray-900/90 p-3 font-mono text-xs`}>
      ...
      <div className="space-y-1 text-gray-400">
        ...
        <div className="flex justify-between"><span>D/G</span><span className="text-white">0.74x</span></div>
...
<a href="${dashboardUrl || 'https://github.com/noahbclarkson/Auto-Tune'}"
   target="_blank"
...
export default function HealthBadgePage() {
  ...
  const [dashboardUrl, setDashboardUrl] = useState('https://your-server.example:8989');
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-gray-900 border border-gray-700 text-white text-sm placeholder-gray-600 focus:outline-none focus:border-emerald-600 transition-colors"
                />
                <p className="text-xs text-gray-500 mt-1.5">Link the badge to your server&apos;s Auto-Tune dashboard. Leave blank to link to the project repo.</p>
              </div>

...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'todo', text: 'Cross-server exchange rate plugin integration' },
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'todo', text: 'Admin health report email digest (weekly)' },
      { status: 'todo', text: 'Player achievement badges and trading milestones' },
    ],
  },
  {
    icon: Shield,

...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      { status: 'done', text: 'TIER3 circuit breaker hysteresis — locks at 0% until D/G drops below tier3 × (1 − band). Default 30× fires, unlocks at 15× with 50% band (92% fewer oscillations)' },
      { status: 'done', text: 'Market event boss bar announcements (in-game)' },
      { status: 'done', text: 'Price anchoring from cross-server true prices (anchored flag in true-prices API)' },
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'in-progress', text: 'Public site live network pages, pending API deployment' },

...
public class AutoTuneGUIShopUserCommand implements CommandExecutor {
                            ...
                            a = new GuiItem(is, event -> {if (event.getClick() == ClickType.LEFT)
                                {
                                    ...
                                    Double[] tempDoublearray = tempmap.get(0);
    ...
    public void createTradingPanel(){
        ...
        is1im.setLore(Arrays.asList(ChatColor.GREEN + Double.toString(price)));
        ...
        is2im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString(price*2)));
        ...
        is4im.setLore(Arrays.asList(ChatColor.GREEN + "$" +Double.toString(price * 4)));
        ...
        is8im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString(price * 8)));
        ...
        is16im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString(price * 16)));
        ...
        is32im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString(price * 32)));
        ...
        is64im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString(price * 64)));
        ...
        GuiItem isa = new GuiItem(is1, event -> {
            ...
            player.sendMessage(ChatColor.GOLD + "Purchased 1x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString(price*1));
            player.setItemOnCursor(null);
                SBPane.clear();
                createTradingPanel();
            }});
        GuiItem isa2 = new GuiItem(is2, event -> {
            ...
            player.sendMessage(ChatColor.GOLD + "Purchased 2x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString(price*2));
                player.setItemOnCursor(null);
                SBPane.clear();
                createTradingPanel();
            }});
        GuiItem isa4 = new GuiItem(is4, event -> {
            ...
            player.sendMessage(ChatColor.GOLD + "Purchased 4x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString(price*4));
                player.setItemOnCursor(null);
                SBPane.clear();
                createTradingPanel();
            }});
        GuiItem isa8 = new GuiItem(is8, event -> {
            ...
            player.sendMessage(ChatColor.GOLD + "Purchased 8x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString(price*8));
                player.setItemOnCursor(null);
                SBPane.clear();
                createTradingPanel();
            }});
        GuiItem isa16 = new GuiItem(is16, event -> {
            ...
            player.sendMessage(ChatColor.GOLD + "Purchased 16x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString(price*16));
                player.setItemOnCursor(null);
                SBPane.clear();
                createTradingPanel();
            }});
        GuiItem isa32 = new GuiItem(is32, event -> {
            ...
            player.sendMessage(ChatColor.GOLD + "Purchased 32x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString(price*32));
                player.setItemOnCursor(null);
                SBPane.clear();
                createTradingPanel();
            }});
        GuiItem isa64 = new GuiItem(is64, event -> {
            ...
            player.sendMessage(ChatColor.GOLD + "Purchased 64x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString(price*64));
                player.setItemOnCursor(null);
                SBPane.clear();
                createTradingPanel();
            }});
            ...
            iss1im.setLore(Arrays.asList(ChatColor.GREEN + Double.toString((price-price*0.01*Config.getSellPriceDifference()))));
            ...
            iss2im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*2)));
            ...
            iss4im.setLore(Arrays.asList(ChatColor.GREEN + "$" +Double.toString((price-price*0.01*Config.getSellPriceDifference()) * 4)));
            ...
            iss8im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference()) * 8)));
            ...
            iss16im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference()) * 16)));
            ...
            iss32im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference()) * 32)));
            ...
            iss64im.setLore(Arrays.asList(ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference()) * 64)));
            ...
            GuiItem issa = new GuiItem(iss1, event -> {
                ...
                if (sellable == true){
                player.sendMessage(ChatColor.GOLD + "Sold 1x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*1));
            ...
            GuiItem issa2 = new GuiItem(iss2, event -> {
                ...
                if ((Player) event.getWhoClicked() == player && player.getInventory().contains(Material.matchMaterial(matClickedString), 2)){
                    ...
                    if (sellable == true){
                    player.sendMessage(ChatColor.GOLD + "Sold 2x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*2));
            ...
            GuiItem issa4 = new GuiItem(iss4, event -> {
                ...
                if ((Player) event.getWhoClicked() == player && player.getInventory().contains(Material.matchMaterial(matClickedString), 4)){
                    ...
                    if (sellable == true){
                    player.sendMessage(ChatColor.GOLD + "Sold 4x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*4));
            ...
            GuiItem issa8 = new GuiItem(iss8, event -> {
                ...
                if ((Player) event.getWhoClicked() == player && player.getInventory().contains(Material.matchMaterial(matClickedString), 8)){
                    ...
                    if (sellable == true){
                    player.sendMessage(ChatColor.GOLD + "Sold 8x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*8));
            ...
            GuiItem issa16 = new GuiItem(iss16, event -> {
                ...
                if ((Player) event.getWhoClicked() == player && player.getInventory().contains(Material.matchMaterial(matClickedString), 16)){
                    ...
                    if (sellable == true){
                    player.sendMessage(ChatColor.GOLD + "Sold 16x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*16));
            ...
            GuiItem issa32 = new GuiItem(iss32, event -> {
                if ((Player) event.getWhoClicked() == player && player.getInventory().contains(Material.matchMaterial(matClickedString), 32)){
                    ...
                    if (sellable == true){
                    player.sendMessage(ChatColor.GOLD + "Sold 32x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*32));
            ...
            GuiItem issa64 = new GuiItem(iss64, event -> {
                ...
                if ((Player) event.getWhoClicked() == player && player.getInventory().contains(Material.matchMaterial(matClickedString), 64)){
                    ...
                    if (sellable == true){
                    player.sendMessage(ChatColor.GOLD + "Sold 64x " + matClickedString + " for " + ChatColor.GREEN + "$" + Double.toString((price-price*0.01*Config.getSellPriceDifference())*64));

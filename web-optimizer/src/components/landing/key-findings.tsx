...
const findings = [
  ...
  },
  {
    ...
    title: '5% GuildBuyer threshold is uniquely safe',
    detail: 'The GuildBuyer default threshold of 15–30% causes catastrophic debt spirals (D/G 5–20×) because selective buying triggers massive credit. At 5%, buying is incremental — creating a natural price floor. D/G drops to 1.67×.',

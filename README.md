...
## Usage
  ...
  #### To use Auto-Tune
    ...
    Note: Make sure you have a vaild API key
...
```
  ...
  #### Auto-Tune API Pricing
    ...
    Pricing at the moment will be variable based on how much we think your server having Auto-Tune will benefit its development and growth
